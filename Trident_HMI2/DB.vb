        ...
        Try
            SyncLock DBobjLock
                ...
                Try
                    ...
                    If rd.Read Then
                        hmiData.year = rd.GetInt16(0)
                        hmiData.month = rd.GetInt16(1)
                        hmiData.day = rd.GetInt16(2)
                        hmiData.hour = rd.GetInt16(3)
                        hmiData.minute = rd.GetInt16(4)
                        hmiData.second = rd.GetInt16(5)
                        hmiData.measureInt7 = rd.GetInt16(6)
                        hmiData.measureInt8 = rd.GetInt16(7)
                        hmiData.measureInt9 = rd.GetInt16(8)
                        hmiData.PH01_Parcel_ID = rd.GetInt16(9)
